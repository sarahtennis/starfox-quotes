...
export const getAllCharacters = (request: express.Request, response: express.Response) => {
  const query  = `
    SELECT
      c.id as id,
      name,
...
export const getCharacterById = (request: express.Request, response: express.Response) => {
